...
USER_AGENT="Neocities Unblocker [11] by KINI/1.5"
concurrent_requests=5
max_page=2750
min_page=2501

for ((current_page = 2501; current_page < max_page; current_page++)); do
    ...
    echo -ne "[11].................($current_page)\r"

    echo "$output" | sed "s|^https://|$NEOCITIES_IP |" | sort -u >> temphosts11 &
...
echo "[11]Done fetching pages from $min_page to $max_page."