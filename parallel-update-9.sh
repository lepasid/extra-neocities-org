...
USER_AGENT="Neocities Unblocker [9] by KINI/1.5"
concurrent_requests=5
max_page=2250
min_page=2001

for ((current_page = 2001; current_page < max_page; current_page++)); do
    ...
    echo -ne "[9].................($current_page)\r"

    echo "$output" | sed "s|^https://|$NEOCITIES_IP |" | sort -u >> temphosts9 &
...
echo "[9]Done fetching pages from $min_page to $max_page."