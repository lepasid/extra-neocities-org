...
USER_AGENT="Neocities Unblocker [7] by KINI/1.5"
concurrent_requests=5
max_page=1750
min_page=1500

for ((current_page = 1500; current_page < max_page; current_page++)); do
    ...
    echo -ne "[7].................($current_page)\r"

    echo "$output" | sed "s|^https://|$NEOCITIES_IP |" | sort -u >> temphosts7 &
...
echo "[7]Done fetching pages from $min_page to $max_page."