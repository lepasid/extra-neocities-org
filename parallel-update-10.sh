...
USER_AGENT="Neocities Unblocker [10] by KINI/1.5"
concurrent_requests=5
max_page=2500
min_page=2250

for ((current_page = 2250; current_page < max_page; current_page++)); do
    ...
    echo -ne "[10].................($current_page)\r"

    echo "$output" | sed "s|^https://|$NEOCITIES_IP |" | sort -u >> temphosts10 &
...
echo "[10]Done fetching pages from $min_page to $max_page."